...
var APP, BIN, CAKE, COFFEE, EXT, NODE, NPM, OUT, SRC, TEST, WINDOWS, clean, compile, exec, finish, install, pathUtil, reset, safe, setup, spawn, test, watch, _ref;
...
clean = function(opts, next) {
  ...
  args = ['-Rf', OUT, pathUtil.join(APP, 'node_modules'), pathUtil.join(APP, '*out'), pathUtil.join(APP, '*log'), pathUtil.join(TEST, 'node_modules'), pathUtil.join(TEST, '*out'), pathUtil.join(TEST, '*log')];
